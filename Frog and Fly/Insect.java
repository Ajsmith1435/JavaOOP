public class Insect {
	...
	private static final String[] FACTS = {
		...
		"There are more than 1 million species of insects",
		"Insects are cold-blooded",
		"Spriders are NOT considered insects"
	};
...
//methods
	...
	public void eat(double amount) {
		System.out.printf("Nibble Nibble");
...
//test method
	public static void main(String[] args) {
		...
		System.out.println("Insect p[opulation: " + population);

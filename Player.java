...
public abstract class Player implements Comparable<Player> {
     ...
     * have an emergency meeting. NOTES: Abstract method, does not return anything
     */
...
public void emergencyMeeting() {}
     ...
     * Override the compareTo method (You should be able to put @Override on the line before the method header) Takes in a Player object and returns an int, adhering to the API contract (Comparable Interface) The method body should compare two Player objects based on the susLevel attribute. If the current Player instance’s susLevel is less than the Player passed in, return a negative number. If it is greater, return a positive number. If their susLevel attributes are equal, return 0
     */
